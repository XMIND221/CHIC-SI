              ...
              <div className="space-y-8">
                <div className="glass-effect p-8 rounded-3xl border border-rose-100/50">
                  ...
                  <p className="text-neutral-600 leading-relaxed">
                    Offrir aux femmes musulmanes des vêtements professionnels qui allient élégance, confort et respect
                    des valeurs islamiques. Chaque pièce Si-Chic est conçue pour sublimer la femme moderne dans son
                ...
                <div className="glass-effect p-8 rounded-3xl border border-champagne-100/50">
                  ...
                  <p className="text-neutral-600 leading-relaxed">
                    Devenir la référence mondiale de la mode modeste professionnelle, en créant un pont entre tradition
                    et modernité, entre élégance et pudeur, pour une femme épanouie et confiante.
                  </p>
                </div>
              </div>
            ...
            <div className="glass-effect p-12 rounded-3xl border border-rose-100/50">
              ...
              <div className="prose prose-lg max-w-none text-neutral-600">
                <p className="text-center leading-relaxed mb-6">
                  ...
                  concilier mes valeurs religieuses avec les exigences vestimentaires du milieu corporate. C'est de
                  cette expérience personnelle qu'est née Si-Chic."
                </p>
