...
import { LayoutDashboard, Package, LogOut, Menu, X, Settings, ImageIcon, Tag, FileText, TrendingUp } from "lucide-react"
...
export function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    ...
    { name: "Tendances", href: "/admin/trends", icon: TrendingUp },
